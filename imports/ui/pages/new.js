  ...
  render () {
    return (
      <div className="plan-text-editor">
        ...
        <hr/>
        <Col className="newplan-edit-button" xs={12} sm={6} smOffset={3} md={4} mdOffset={4}>
          <Button bsStyle="primary" onClick={this.open.bind(this)} block>Edit</Button>
        </Col>
        <br/>
        <Modal show={this.state.showModal} onHide={this.close.bind(this)}>
          <Modal.Header closeButton>
            <Modal.Title>Edit and Review</Modal.Title>
